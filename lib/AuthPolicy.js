...
class AuthPolicy {
   ...
   * @return {void}
   */
  static addMethod(effect, verb, resource, conditions) {
    ...
    const resourceArn = `arn:aws:execute-api:${this.region}:${this.awsAccountId}:${
      this.restApiId
   ...
   */
  allowAllMethods() {
    AuthPolicy.addMethod.call(this, 'allow', '*', '*', null);
  }
   ...
   */
  denyAllMethods() {
    AuthPolicy.addMethod.call(this, 'deny', '*', '*', null);
  }
  ...
  allowMethod(verb, resource) {
    AuthPolicy.addMethod.call(this, 'allow', verb, resource, null);
  }
  ...
  denyMethod(verb, resource) {
    AuthPolicy.addMethod.call(this, 'deny', verb, resource, null);
  }
  ...
  allowMethodWithConditions(verb, resource, conditions) {
    AuthPolicy.addMethod.call(this, 'allow', verb, resource, conditions);
  }
  ...
  denyMethodWithConditions(verb, resource, conditions) {
    AuthPolicy.addMethod.call(this, 'deny', verb, resource, conditions);
  }
  ...
  build() {
    ...
    doc.Statement = doc.Statement.concat(AuthPolicy.getStatementsForEffect.call(this, 'Allow', this.allowMethods));
    doc.Statement = doc.Statement.concat(AuthPolicy.getStatementsForEffect.call(this, 'Deny', this.denyMethods));
